...
class TextEditor:
    ...
    def overwrite_filename(self, file_name):
        """
        This method overwrites every element of the list into a file
        :return: none
        :raises: no exceptions
        :pre-condition: filename is of python or text type.
        :post-condition: a file with every element of the list in a separate line in order
    ...
    def __len__(self):
        ...
        :raises: no exceptions
        :pre-condition: none
        :post-condition: returns length of the list
        :complexity: O(1), constant time
        """
